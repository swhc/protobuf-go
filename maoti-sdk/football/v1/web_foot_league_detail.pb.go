...
type WebFootLeagueDetailResponse struct {
	...
	LeagueType  string                     `protobuf:"bytes,9,opt,name=LeagueType,proto3" json:"LeagueType,omitempty"`   //联赛类型：2.联赛；1.杯赛
...
func (x *WebFootLeagueDetailResponse) GetLeagueType() string {
	if x != nil {
		return x.LeagueType
	}
	return ""
...
var file_web_foot_league_detail_proto_rawDesc = []byte{
	...
	0x20, 0x01, 0x28, 0x09, 0x52, 0x0a, 0x4c, 0x65, 0x61, 0x67, 0x75, 0x65, 0x54, 0x79, 0x70, 0x65,
