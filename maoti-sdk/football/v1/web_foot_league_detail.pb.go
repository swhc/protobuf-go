...
func (x *WebFootLeagueStats) GetPlayerId() int64 {
	if x != nil {
		return x.PlayerId
	}
	return 0
...
func (x *WebFootLeagueStats) GetPlayerName() string {
	if x != nil {
		return x.PlayerName
	}
	return ""
...
func (x *WebFootLeagueStats) GetData() int64 {
	if x != nil {
		return x.Data
	}
	return 0
...
func (x *WebFootLeagueStats) GetCorner() int64 {
	if x != nil {
		return x.Corner
	}
	return 0
...
var file_web_foot_league_detail_proto_rawDesc = []byte{
	...
	0x61, 0x74, 0x61, 0x22, 0x90, 0x01, 0x0a, 0x12, 0x57, 0x65, 0x62, 0x46, 0x6f, 0x6f, 0x74, 0x4c,
	...
	0x70, 0x6c, 0x61, 0x79, 0x65, 0x72, 0x4e, 0x61, 0x6d, 0x65, 0x12, 0x12, 0x0a, 0x04, 0x64, 0x61,
	...
	0x63, 0x6f, 0x72, 0x6e, 0x65, 0x72, 0x42, 0x07, 0x5a, 0x05, 0x2e, 0x2f, 0x3b, 0x76, 0x31, 0x62,
