...
type FootLiveOddsList struct {
	...
	OddUpTime       int64  `protobuf:"varint,10,opt,name=oddUpTime,proto3" json:"oddUpTime,omitempty"`                                    //指数时间
}
...
func (x *FootLiveOddsList) GetOddUpTime() int64 {
	if x != nil {
		return x.OddUpTime
	}
	return 0
...
var file_foot_live_stat_proto_rawDesc = []byte{
	...
	0x54, 0x69, 0x6d, 0x65, 0x18, 0x0a, 0x20, 0x01, 0x28, 0x03, 0x52, 0x09, 0x6f, 0x64, 0x64, 0x55,
