...
func (x *V2FootMatchAgainstDetailRequest) GetSportId() string {
	if x != nil {
		return x.SportId
	}
	return ""
...
func (x *V2FootMatchAgainstDetailRequest) GetEventId() string {
	if x != nil {
		return x.EventId
	}
	return ""
...
var file_v2_foot_match_against_detail_proto_rawDesc = []byte{
	...
	0x20, 0x01, 0x28, 0x09, 0x52, 0x07, 0x73, 0x70, 0x6f, 0x72, 0x74, 0x49, 0x64, 0x12, 0x18, 0x0a,
