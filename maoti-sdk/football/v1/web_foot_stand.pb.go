...
type LeagueStandInfo struct {
	...
	Trend     int64  `protobuf:"varint,11,opt,name=trend,proto3" json:"trend,omitempty"`        //近六场走势
}
...
func (x *LeagueStandInfo) GetTrend() int64 {
	if x != nil {
		return x.Trend
	}
	return 0
...
var file_web_foot_stand_proto_rawDesc = []byte{
	...
	0x65, 0x6e, 0x64, 0x18, 0x0b, 0x20, 0x01, 0x28, 0x03, 0x52, 0x05, 0x74, 0x72, 0x65, 0x6e, 0x64,
