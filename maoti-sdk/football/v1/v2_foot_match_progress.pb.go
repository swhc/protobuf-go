...
type V2FootMatchProgressResponse struct {
	...
	CurrMatchStatus int64                      `protobuf:"varint,7,opt,name=currMatchStatus,proto3" json:"currMatchStatus,omitempty"` //比赛状态：1.未开始；2.上半场；3.下半场；4.进行中；5.加时；6.加时上半场；7.加时下半场；8.点球；9.暂停；10.中场；11.等待加时赛；12.加时赛中场；13.加时赛后；14.等待点球决胜；15.点球决胜后；16.取消；17.延期；18.推迟；19.中断；20.弃赛；21.待定；22.完场
}
...
type V2FootMatchProgressInfo struct {
	...
	MatchStatus  int64 `protobuf:"varint,7,opt,name=matchStatus,proto3" json:"matchStatus,omitempty"`   //事件进行时的比赛状态：0.未开始；1.上半场；2.下半场；10.进行中；21.加时上半场；22.加时下半场；25.点球；30.暂停；31.中场；32.等待加时赛；33.加时赛中场；34.加时赛后；35.等待点球决胜；36.点球决胜后；40.取消；41.延期；42.推迟；43.中断；44.弃赛；45.待定；100.完场
}
...
var file_v2_foot_match_progress_proto_rawDesc = []byte{
	...
	0x66, 0x6f, 0x52, 0x08, 0x70, 0x72, 0x6f, 0x67, 0x72, 0x65, 0x73, 0x73, 0x12, 0x28, 0x0a, 0x0f,
	0x63, 0x75, 0x72, 0x72, 0x4d, 0x61, 0x74, 0x63, 0x68, 0x53, 0x74, 0x61, 0x74, 0x75, 0x73, 0x18,
	0x07, 0x20, 0x01, 0x28, 0x03, 0x52, 0x0f, 0x63, 0x75, 0x72, 0x72, 0x4d, 0x61, 0x74, 0x63, 0x68,
	0x53, 0x74, 0x61, 0x74, 0x75, 0x73, 0x22, 0x93, 0x01, 0x0a, 0x17, 0x56, 0x32, 0x46, 0x6f, 0x6f,
	0x74, 0x4d, 0x61, 0x74, 0x63, 0x68, 0x50, 0x72, 0x6f, 0x67, 0x72, 0x65, 0x73, 0x73, 0x49, 0x6e,
	...
	0x74, 0x63, 0x68, 0x53, 0x74, 0x61, 0x74, 0x75, 0x73, 0x18, 0x07, 0x20, 0x01, 0x28, 0x03, 0x52,
	0x0b, 0x6d, 0x61, 0x74, 0x63, 0x68, 0x53, 0x74, 0x61, 0x74, 0x75, 0x73, 0x42, 0x07, 0x5a, 0x05,
