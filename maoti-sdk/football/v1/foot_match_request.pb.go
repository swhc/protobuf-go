...
type FootMatchInfoResponse struct {
	...
	TournamentLogo    int64              `protobuf:"varint,39,opt,name=TournamentLogo,proto3" json:"TournamentLogo,omitempty"` //联赛logo
...
func (x *FootMatchInfoResponse) GetTournamentLogo() int64 {
	if x != nil {
...
var file_foot_match_request_proto_rawDesc = []byte{
	...
	0x6d, 0x65, 0x6e, 0x74, 0x4c, 0x6f, 0x67, 0x6f, 0x18, 0x27, 0x20, 0x01, 0x28, 0x03, 0x52, 0x0e,
