...
type WebOddDetailRequest struct {
	...
	CompanyID string `protobuf:"bytes,4,opt,name=companyID,proto3" json:"companyID,omitempty"` //指数公司ID
	OddType   int64  `protobuf:"varint,5,opt,name=oddType,proto3" json:"oddType,omitempty"`    //指数类型 1.亚盘；2.欧赔；3.大小球
...
func (x *WebOddDetailRequest) GetCompanyID() string {
	if x != nil {
		return x.CompanyID
	}
	return ""
...
var file_web_foot_odd_detail_proto_rawDesc = []byte{
	...
	0x6c, 0x22, 0xb3, 0x01, 0x0a, 0x09, 0x4f, 0x64, 0x64, 0x44, 0x65, 0x74, 0x61, 0x69, 0x6c, 0x12,
	...
	0x65, 0x73, 0x74, 0x42, 0x61, 0x6c, 0x6c, 0x42, 0x07, 0x5a, 0x05, 0x2e, 0x2f, 0x3b, 0x76, 0x31,
