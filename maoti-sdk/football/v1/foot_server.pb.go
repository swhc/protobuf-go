...
var file_foot_server_proto_rawDesc = []byte{
	...
	0x74, 0x61, 0x18, 0x03, 0x20, 0x01, 0x28, 0x0c, 0x52, 0x04, 0x64, 0x61, 0x74, 0x61, 0x32, 0xc7,
	0x01, 0x0a, 0x08, 0x46, 0x6f, 0x6f, 0x74, 0x42, 0x61, 0x6c, 0x6c, 0x12, 0x40, 0x0a, 0x16, 0x46,
...
var file_foot_server_proto_goTypes = []interface{}{
	...
	(*FootSeasonListRequest)(nil), // 3: FootSeasonListRequest
	(*FootPlayerInfoRequest)(nil), // 4: FootPlayerInfoRequest
}
var file_foot_server_proto_depIdxs = []int32{
	2, // 0: FootBall.FootMatchAgainstDetail:input_type -> FootMatchInfoRequest
	3, // 1: FootBall.GetFootSeasonList:input_type -> FootSeasonListRequest
	4, // 2: FootBall.FootPlayerDetail:input_type -> FootPlayerInfoRequest
	1, // 3: FootBall.FootMatchAgainstDetail:output_type -> FootResponse
	1, // 4: FootBall.GetFootSeasonList:output_type -> FootResponse
	1, // 5: FootBall.FootPlayerDetail:output_type -> FootResponse
