...
var file_foot_server_proto_rawDesc = []byte{
	...
	0x74, 0x61, 0x32, 0xbc, 0x24, 0x0a, 0x08, 0x46, 0x6f, 0x6f, 0x74, 0x42, 0x61, 0x6c, 0x6c, 0x12,
	...
	0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x22, 0x00, 0x12, 0x3e, 0x0a, 0x0e, 0x46, 0x6f, 0x6f,
	0x74, 0x52, 0x65, 0x61, 0x6c, 0x54, 0x69, 0x6d, 0x65, 0x56, 0x32, 0x12, 0x1b, 0x2e, 0x46, 0x6f,
	0x6f, 0x74, 0x4d, 0x61, 0x74, 0x63, 0x68, 0x52, 0x65, 0x61, 0x6c, 0x54, 0x69, 0x6d, 0x65, 0x52,
	0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x56, 0x32, 0x1a, 0x0d, 0x2e, 0x46, 0x6f, 0x6f, 0x74, 0x52,
	...
	0x61, 0x74, 0x63, 0x68, 0x4c, 0x69, 0x6e, 0x65, 0x75, 0x70, 0x12, 0x1a, 0x2e, 0x57, 0x65, 0x62,
...
var file_foot_server_proto_goTypes = []interface{}{
	...
	(*FutureMatchCountRequest)(nil),                   // 66: FutureMatchCountRequest
	(*FootMatchDetailAllRequest)(nil),                 // 67: FootMatchDetailAllRequest
	(*FootMatchFinishRequest)(nil),                    // 68: FootMatchFinishRequest
	(*WebFootMatchLineupRequest)(nil),                 // 69: WebFootMatchLineupRequest
	(*FavoriteMatchRequest)(nil),                      // 70: FavoriteMatchRequest
	(*CheckMatchStatusRequest)(nil),                   // 71: CheckMatchStatusRequest
	(*SqliteDbTimeRequest)(nil),                       // 72: SqliteDbTimeRequest
	(*SqliteDbDataRequest)(nil),                       // 73: SqliteDbDataRequest
	(*FootMatchInProgressResponse)(nil),               // 74: FootMatchInProgressResponse
}
var file_foot_server_proto_depIdxs = []int32{
	...
	66, // 64: FootBall.FutureMatchCount:input_type -> FutureMatchCountRequest
	67, // 65: FootBall.FootMatchDetailAll:input_type -> FootMatchDetailAllRequest
	68, // 66: FootBall.MatchFinish:input_type -> FootMatchFinishRequest
	69, // 67: FootBall.WebFootMatchLineup:input_type -> WebFootMatchLineupRequest
	70, // 68: FootBall.FavoriteMatchList:input_type -> FavoriteMatchRequest
	71, // 69: FootBall.CheckMatchStatus:input_type -> CheckMatchStatusRequest
	72, // 70: FootBall.SqliteDbTime:input_type -> SqliteDbTimeRequest
	73, // 71: FootBall.SqliteDbData:input_type -> SqliteDbDataRequest
	1,  // 72: FootBall.FootMatchAgainstDetail:output_type -> FootResponse
	1,  // 73: FootBall.GetMatchOddList:output_type -> FootResponse
	1,  // 74: FootBall.GetMatchOddListDetail:output_type -> FootResponse
	1,  // 75: FootBall.GetFootSeasonList:output_type -> FootResponse
	1,  // 76: FootBall.FootPlayerDetail:output_type -> FootResponse
	1,  // 77: FootBall.FootMatchCommentList:output_type -> FootResponse
	1,  // 78: FootBall.GetFootMatchFiltrate:output_type -> FootResponse
	1,  // 79: FootBall.GetFootContinentCountryTournamentData:output_type -> FootResponse
	1,  // 80: FootBall.FootTeamDetail:output_type -> FootResponse
	1,  // 81: FootBall.FootStandTag:output_type -> FootResponse
	1,  // 82: FootBall.FootTeamMatch:output_type -> FootResponse
	1,  // 83: FootBall.FootMatchTeamLineup:output_type -> FootResponse
	1,  // 84: FootBall.FootTeamStand:output_type -> FootResponse
	1,  // 85: FootBall.FootTodayMatch:output_type -> FootResponse
	1,  // 86: FootBall.GetFootLeagueStand:output_type -> FootResponse
	1,  // 87: FootBall.FootTeamTransfer:output_type -> FootResponse
	1,  // 88: FootBall.GetFootPlayerStand:output_type -> FootResponse
	1,  // 89: FootBall.FootLiveLineup:output_type -> FootResponse
	1,  // 90: FootBall.FootLiveStat:output_type -> FootResponse
	1,  // 91: FootBall.FootPlayerCareer:output_type -> FootResponse
	1,  // 92: FootBall.FootTeamTransferYear:output_type -> FootResponse
	1,  // 93: FootBall.GetFootCheckExistence:output_type -> FootResponse
	1,  // 94: FootBall.FootFiltrationId:output_type -> FootResponse
	1,  // 95: FootBall.GetDataTypeCount:output_type -> FootResponse
	1,  // 96: FootBall.CheckFootData:output_type -> FootResponse
	1,  // 97: FootBall.FootRealTime:output_type -> FootResponse
	1,  // 98: FootBall.FootRealTimeV2:output_type -> FootResponse
	1,  // 99: FootBall.FootOddsFilter:output_type -> FootResponse
	1,  // 100: FootBall.FootMatchList:output_type -> FootResponse
	1,  // 101: FootBall.FootMatchPlus:output_type -> FootResponse
	1,  // 102: FootBall.FootMatchBase:output_type -> FootResponse
	74, // 103: FootBall.FootMatchInProgress:output_type -> FootMatchInProgressResponse
	1,  // 104: FootBall.FootDataPromotion:output_type -> FootResponse
	1,  // 105: FootBall.FootLineupAverageData:output_type -> FootResponse
	1,  // 106: FootBall.FootLineupMatchData:output_type -> FootResponse
	1,  // 107: FootBall.FootQuestionMatch:output_type -> FootResponse
	1,  // 108: FootBall.WebFootSeasonList:output_type -> FootResponse
	1,  // 109: FootBall.GetWebOddList:output_type -> FootResponse
	1,  // 110: FootBall.WebFootTeamDetail:output_type -> FootResponse
	1,  // 111: FootBall.WebFootTeamMatch:output_type -> FootResponse
	1,  // 112: FootBall.WebFootTeamPlayer:output_type -> FootResponse
	1,  // 113: FootBall.WebFootTransfer:output_type -> FootResponse
	1,  // 114: FootBall.WebFootTeamTransferYear:output_type -> FootResponse
	1,  // 115: FootBall.WebFootTeamStatsMenu:output_type -> FootResponse
	1,  // 116: FootBall.WebFootTeamStats:output_type -> FootResponse
	1,  // 117: FootBall.WebFootTeamSeasonList:output_type -> FootResponse
	1,  // 118: FootBall.WebFootMatchList:output_type -> FootResponse
	1,  // 119: FootBall.WebFootMatchMonth:output_type -> FootResponse
	1,  // 120: FootBall.WebFootTeamTransferInjury:output_type -> FootResponse
	1,  // 121: FootBall.WebFootMatchLastLineup:output_type -> FootResponse
	1,  // 122: FootBall.WebFootPlayerDetail:output_type -> FootResponse
	1,  // 123: FootBall.WebFootLeagueDetail:output_type -> FootResponse
	1,  // 124: FootBall.WebLeagueStand:output_type -> FootResponse
	1,  // 125: FootBall.WebFootLeagueStatsMenu:output_type -> FootResponse
	1,  // 126: FootBall.WebFootLeagueTeam:output_type -> FootResponse
	1,  // 127: FootBall.WebFootLeagueStats:output_type -> FootResponse
	1,  // 128: FootBall.WebFootMatchDetail:output_type -> FootResponse
	1,  // 129: FootBall.WebFootContinentLeague:output_type -> FootResponse
	1,  // 130: FootBall.WebFootMatchCount:output_type -> FootResponse
	1,  // 131: FootBall.WebFootMatchIncident:output_type -> FootResponse
	1,  // 132: FootBall.WebFootInstantMatch:output_type -> FootResponse
	1,  // 133: FootBall.WebFootLeagueFilter:output_type -> FootResponse
	1,  // 134: FootBall.WebFootOddDetail:output_type -> FootResponse
	1,  // 135: FootBall.WebOddHandicapOU:output_type -> FootResponse
	1,  // 136: FootBall.FutureMatchCount:output_type -> FootResponse
	1,  // 137: FootBall.FootMatchDetailAll:output_type -> FootResponse
	1,  // 138: FootBall.MatchFinish:output_type -> FootResponse
	1,  // 139: FootBall.WebFootMatchLineup:output_type -> FootResponse
	1,  // 140: FootBall.FavoriteMatchList:output_type -> FootResponse
	1,  // 141: FootBall.CheckMatchStatus:output_type -> FootResponse
	1,  // 142: FootBall.SqliteDbTime:output_type -> FootResponse
	1,  // 143: FootBall.SqliteDbData:output_type -> FootResponse
