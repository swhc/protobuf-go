...
var file_foot_server_proto_rawDesc = []byte{
	...
	0x68, 0x5f, 0x6c, 0x69, 0x73, 0x74, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x1a, 0x15, 0x66, 0x6f,
	0x6f, 0x74, 0x5f, 0x74, 0x65, 0x61, 0x6d, 0x5f, 0x73, 0x74, 0x61, 0x6e, 0x64, 0x2e, 0x70, 0x72,
	...
	0x74, 0x61, 0x32, 0x8a, 0x07, 0x0a, 0x08, 0x46, 0x6f, 0x6f, 0x74, 0x42, 0x61, 0x6c, 0x6c, 0x12,
	...
	0x69, 0x6e, 0x65, 0x75, 0x70, 0x12, 0x15, 0x2e, 0x46, 0x6f, 0x6f, 0x74, 0x54, 0x65, 0x61, 0x6d,
...
var file_foot_server_proto_goTypes = []interface{}{
	...
	(*FootTeamStandRequest)(nil),                      // 13: FootTeamStandRequest
}
var file_foot_server_proto_depIdxs = []int32{
	...
	12, // 11: FootBall.FootMatchTeamLineup:input_type -> FootTeamMatchRequest
	12, // 12: FootBall.FootMatchList:input_type -> FootTeamMatchRequest
	13, // 13: FootBall.FootTeamStand:input_type -> FootTeamStandRequest
	1,  // 14: FootBall.FootMatchAgainstDetail:output_type -> FootResponse
	1,  // 15: FootBall.GetMatchOddList:output_type -> FootResponse
	1,  // 16: FootBall.GetMatchOddListDetail:output_type -> FootResponse
	1,  // 17: FootBall.GetFootSeasonList:output_type -> FootResponse
	1,  // 18: FootBall.FootPlayerDetail:output_type -> FootResponse
	1,  // 19: FootBall.FootMatchCommentList:output_type -> FootResponse
	1,  // 20: FootBall.GetFootMatchFiltrate:output_type -> FootResponse
	1,  // 21: FootBall.GetFootContinentCountryTournamentData:output_type -> FootResponse
	1,  // 22: FootBall.FootTeamDetail:output_type -> FootResponse
	1,  // 23: FootBall.FootStandTag:output_type -> FootResponse
	1,  // 24: FootBall.FootTeamMatch:output_type -> FootResponse
	1,  // 25: FootBall.FootMatchTeamLineup:output_type -> FootResponse
	1,  // 26: FootBall.FootMatchList:output_type -> FootResponse
	1,  // 27: FootBall.FootTeamStand:output_type -> FootResponse
...
type FootBallClient interface {
	...
	//球队阵容
	FootMatchTeamLineup(ctx context.Context, in *FootTeamMatchRequest, opts ...grpc.CallOption) (*FootResponse, error)
	//全部比赛（即时，赛程，赛果）
	FootMatchList(ctx context.Context, in *FootTeamMatchRequest, opts ...grpc.CallOption) (*FootResponse, error)
	//球队榜单
...
func (c *footBallClient) FootMatchTeamLineup(ctx context.Context, in *FootTeamMatchRequest, opts ...grpc.CallOption) (*FootResponse, error) {
	out := new(FootResponse)
...
func (c *footBallClient) FootMatchList(ctx context.Context, in *FootTeamMatchRequest, opts ...grpc.CallOption) (*FootResponse, error) {
	out := new(FootResponse)
...
type FootBallServer interface {
	...
	//球队阵容
	FootMatchTeamLineup(context.Context, *FootTeamMatchRequest) (*FootResponse, error)
	//全部比赛（即时，赛程，赛果）
	FootMatchList(context.Context, *FootTeamMatchRequest) (*FootResponse, error)
	//球队榜单
...
func (*UnimplementedFootBallServer) FootMatchTeamLineup(context.Context, *FootTeamMatchRequest) (*FootResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method FootMatchTeamLineup not implemented")
}
func (*UnimplementedFootBallServer) FootMatchList(context.Context, *FootTeamMatchRequest) (*FootResponse, error) {
...
func _FootBall_FootMatchTeamLineup_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(FootBallServer).FootMatchTeamLineup(ctx, req.(*FootTeamMatchRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
func _FootBall_FootMatchList_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(FootBallServer).FootMatchList(ctx, req.(*FootTeamMatchRequest))
	}
	return interceptor(ctx, in, info, handler)
}
