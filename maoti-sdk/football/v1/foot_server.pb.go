...
var file_foot_server_proto_rawDesc = []byte{
	...
	0x90, 0x2b, 0x0a, 0x08, 0x46, 0x6f, 0x6f, 0x74, 0x42, 0x61, 0x6c, 0x6c, 0x12, 0x40, 0x0a, 0x16,
	...
	0x71, 0x75, 0x65, 0x73, 0x74, 0x1a, 0x0d, 0x2e, 0x46, 0x6f, 0x6f, 0x74, 0x52, 0x65, 0x73, 0x70,
	0x6f, 0x6e, 0x73, 0x65, 0x22, 0x00, 0x12, 0x3a, 0x0a, 0x10, 0x46, 0x6f, 0x6f, 0x74, 0x52, 0x65,
	0x61, 0x6c, 0x45, 0x76, 0x65, 0x6e, 0x4c, 0x69, 0x76, 0x65, 0x12, 0x15, 0x2e, 0x52, 0x65, 0x61,
...
var file_foot_server_proto_depIdxs = []int32{
	...
	84, // 82: FootBall.FootRealEvenLive:input_type -> RealEventLiveRequest
...
type FootBallClient interface {
	...
	//比赛实时直播动画
	FootRealEvenLive(ctx context.Context, in *RealEventLiveRequest, opts ...grpc.CallOption) (*FootResponse, error)
}
...
func (c *footBallClient) FootRealEvenLive(ctx context.Context, in *RealEventLiveRequest, opts ...grpc.CallOption) (*FootResponse, error) {
	out := new(FootResponse)
...
type FootBallServer interface {
	...
	//比赛实时直播动画
	FootRealEvenLive(context.Context, *RealEventLiveRequest) (*FootResponse, error)
}
...
func (*UnimplementedFootBallServer) FootRealEvenLive(context.Context, *RealEventLiveRequest) (*FootResponse, error) {
...
func _FootBall_FootRealEvenLive_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(FootBallServer).FootRealEvenLive(ctx, req.(*RealEventLiveRequest))
	}
	return interceptor(ctx, in, info, handler)
}
