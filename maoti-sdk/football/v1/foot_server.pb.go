...
var file_foot_server_proto_rawDesc = []byte{
	...
	0x70, 0x72, 0x6f, 0x74, 0x6f, 0x1a, 0x14, 0x66, 0x6f, 0x6f, 0x74, 0x5f, 0x70, 0x6c, 0x75, 0x73,
	...
	0x20, 0x01, 0x28, 0x0c, 0x52, 0x04, 0x64, 0x61, 0x74, 0x61, 0x32, 0x9e, 0x0e, 0x0a, 0x08, 0x46,
	...
	0x73, 0x65, 0x22, 0x00, 0x12, 0x35, 0x0a, 0x0c, 0x46, 0x6f, 0x6f, 0x74, 0x50, 0x6c, 0x75, 0x73,
	0x44, 0x61, 0x74, 0x61, 0x12, 0x14, 0x2e, 0x46, 0x6f, 0x6f, 0x74, 0x50, 0x6c, 0x75, 0x73, 0x44,
...
var file_foot_server_proto_goTypes = []interface{}{
	...
	(*FootPlusDataRequest)(nil),                       // 30: FootPlusDataRequest
}
var file_foot_server_proto_depIdxs = []int32{
	...
	30, // 28: FootBall.FootPlusData:input_type -> FootPlusDataRequest
	1,  // 29: FootBall.FootMatchAgainstDetail:output_type -> FootResponse
	1,  // 30: FootBall.GetMatchOddList:output_type -> FootResponse
	1,  // 31: FootBall.GetMatchOddListDetail:output_type -> FootResponse
	1,  // 32: FootBall.GetFootSeasonList:output_type -> FootResponse
	1,  // 33: FootBall.FootPlayerDetail:output_type -> FootResponse
	1,  // 34: FootBall.FootMatchCommentList:output_type -> FootResponse
	1,  // 35: FootBall.GetFootMatchFiltrate:output_type -> FootResponse
	1,  // 36: FootBall.GetFootContinentCountryTournamentData:output_type -> FootResponse
	1,  // 37: FootBall.FootTeamDetail:output_type -> FootResponse
	1,  // 38: FootBall.FootStandTag:output_type -> FootResponse
	1,  // 39: FootBall.FootTeamMatch:output_type -> FootResponse
	1,  // 40: FootBall.FootMatchTeamLineup:output_type -> FootResponse
	1,  // 41: FootBall.FootTeamStand:output_type -> FootResponse
	1,  // 42: FootBall.FootTodayMatch:output_type -> FootResponse
	1,  // 43: FootBall.GetFootLeagueStand:output_type -> FootResponse
	1,  // 44: FootBall.FootTeamTransfer:output_type -> FootResponse
	1,  // 45: FootBall.GetFootPlayerStand:output_type -> FootResponse
	1,  // 46: FootBall.FootLiveLineup:output_type -> FootResponse
	1,  // 47: FootBall.FootLiveStat:output_type -> FootResponse
	1,  // 48: FootBall.FootPlayerCareer:output_type -> FootResponse
	1,  // 49: FootBall.FootTeamTransferYear:output_type -> FootResponse
	1,  // 50: FootBall.GetFootCheckExistence:output_type -> FootResponse
	1,  // 51: FootBall.FootFiltrationId:output_type -> FootResponse
	1,  // 52: FootBall.GetDataTypeCount:output_type -> FootResponse
	1,  // 53: FootBall.CheckFootData:output_type -> FootResponse
	1,  // 54: FootBall.FootRealTime:output_type -> FootResponse
	1,  // 55: FootBall.FootOddsFilter:output_type -> FootResponse
	1,  // 56: FootBall.FootMatchList:output_type -> FootResponse
	1,  // 57: FootBall.FootPlusData:output_type -> FootResponse
...
func file_foot_server_proto_init() {
	...
	file_foot_plus_data_proto_init()
	if !protoimpl.UnsafeEnabled {
...
type FootBallClient interface {
	...
	// 增强数据
	FootPlusData(ctx context.Context, in *FootPlusDataRequest, opts ...grpc.CallOption) (*FootResponse, error)
}
...
func (c *footBallClient) FootPlusData(ctx context.Context, in *FootPlusDataRequest, opts ...grpc.CallOption) (*FootResponse, error) {
	out := new(FootResponse)
	err := c.cc.Invoke(ctx, "/FootBall/FootPlusData", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type FootBallServer interface {
	...
	// 增强数据
	FootPlusData(context.Context, *FootPlusDataRequest) (*FootResponse, error)
}
...
func (*UnimplementedFootBallServer) FootPlusData(context.Context, *FootPlusDataRequest) (*FootResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method FootPlusData not implemented")
}
...
func _FootBall_FootPlusData_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(FootPlusDataRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(FootBallServer).FootPlusData(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/FootBall/FootPlusData",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(FootBallServer).FootPlusData(ctx, req.(*FootPlusDataRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var _FootBall_serviceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "FootPlusData",
			Handler:    _FootBall_FootPlusData_Handler,
		},
	},
