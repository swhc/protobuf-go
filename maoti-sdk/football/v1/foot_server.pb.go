...
var file_foot_server_proto_rawDesc = []byte{
	...
	0x04, 0x64, 0x61, 0x74, 0x61, 0x32, 0xfa, 0x0b, 0x0a, 0x08, 0x46, 0x6f, 0x6f, 0x74, 0x42, 0x61,
	...
	0x65, 0x22, 0x00, 0x12, 0x34, 0x0a, 0x0b, 0x46, 0x6f, 0x6f, 0x74, 0x4c, 0x69, 0x76, 0x65, 0x53,
	0x74, 0x61, 0x12, 0x14, 0x2e, 0x46, 0x6f, 0x6f, 0x74, 0x4c, 0x69, 0x76, 0x65, 0x53, 0x74, 0x61,
...
var file_foot_server_proto_depIdxs = []int32{
	...
	21, // 19: FootBall.FootLiveSta:input_type -> FootLiveStatRequest
	...
	1,  // 24: FootBall.FootMatchAgainstDetail:output_type -> FootResponse
	1,  // 25: FootBall.GetMatchOddList:output_type -> FootResponse
	1,  // 26: FootBall.GetMatchOddListDetail:output_type -> FootResponse
	1,  // 27: FootBall.GetFootSeasonList:output_type -> FootResponse
	1,  // 28: FootBall.FootPlayerDetail:output_type -> FootResponse
	1,  // 29: FootBall.FootMatchCommentList:output_type -> FootResponse
	1,  // 30: FootBall.GetFootMatchFiltrate:output_type -> FootResponse
	1,  // 31: FootBall.GetFootContinentCountryTournamentData:output_type -> FootResponse
	1,  // 32: FootBall.FootTeamDetail:output_type -> FootResponse
	1,  // 33: FootBall.FootStandTag:output_type -> FootResponse
	1,  // 34: FootBall.FootTeamMatch:output_type -> FootResponse
	1,  // 35: FootBall.FootMatchTeamLineup:output_type -> FootResponse
	1,  // 36: FootBall.FootMatchList:output_type -> FootResponse
	1,  // 37: FootBall.FootTeamStand:output_type -> FootResponse
	1,  // 38: FootBall.FootTodayMatch:output_type -> FootResponse
	1,  // 39: FootBall.GetFootLeagueStand:output_type -> FootResponse
	1,  // 40: FootBall.FootTeamTransfer:output_type -> FootResponse
	1,  // 41: FootBall.GetFootPlayerStand:output_type -> FootResponse
	1,  // 42: FootBall.FootLiveLineup:output_type -> FootResponse
	1,  // 43: FootBall.FootLiveSta:output_type -> FootResponse
	1,  // 44: FootBall.FootPlayerCareer:output_type -> FootResponse
	1,  // 45: FootBall.FootTeamTransferYear:output_type -> FootResponse
	1,  // 46: FootBall.GetFootCheckExistence:output_type -> FootResponse
	1,  // 47: FootBall.FootFiltrationId:output_type -> FootResponse
...
type FootBallClient interface {
	...
	//直播 - 直播统计
	FootLiveSta(ctx context.Context, in *FootLiveStatRequest, opts ...grpc.CallOption) (*FootResponse, error)
	//球员职业生涯
...
func (c *footBallClient) FootLiveSta(ctx context.Context, in *FootLiveStatRequest, opts ...grpc.CallOption) (*FootResponse, error) {
	out := new(FootResponse)
	err := c.cc.Invoke(ctx, "/FootBall/FootLiveSta", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type FootBallServer interface {
	...
	//直播 - 直播统计
	FootLiveSta(context.Context, *FootLiveStatRequest) (*FootResponse, error)
	//球员职业生涯
...
func (*UnimplementedFootBallServer) FootLiveSta(context.Context, *FootLiveStatRequest) (*FootResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method FootLiveSta not implemented")
}
...
func _FootBall_FootLiveSta_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(FootLiveStatRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(FootBallServer).FootLiveSta(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/FootBall/FootLiveSta",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(FootBallServer).FootLiveSta(ctx, req.(*FootLiveStatRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var _FootBall_serviceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "FootLiveSta",
			Handler:    _FootBall_FootLiveSta_Handler,
		},
		{
