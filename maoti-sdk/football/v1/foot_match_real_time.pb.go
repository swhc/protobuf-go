...
type FootMatchRealTimeRequest struct {
	...
	TournamentId []int64 `protobuf:"varint,1,rep,packed,name=tournamentId,proto3" json:"tournamentId,omitempty"` //赛事筛选，联赛ID
	NationId     []int64 `protobuf:"varint,9,rep,packed,name=nationId,proto3" json:"nationId,omitempty"`         //赛事筛选，国家ID
...
func (x *FootMatchRealTimeRequest) GetNationId() []int64 {
	if x != nil {
		return x.NationId
	}
	return nil
...
func (x *FootMatchRealTimeRequest) GetLanguage() string {
	if x != nil {
		return x.Language
	}
	return ""
...
type FootMatchRealTimeResponse struct {
	...
	List  []*FootMatchRealTimeList `protobuf:"bytes,2,rep,name=list,proto3" json:"list,omitempty"`
}
...
func (x *FootMatchRealTimeResponse) GetList() []*FootMatchRealTimeList {
	if x != nil {
		return x.List
	}
	return nil
...
type FootMatchRealTimeList struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields

	TournamentName    string                   `protobuf:"bytes,1,opt,name=tournamentName,proto3" json:"tournamentName,omitempty"`        //  联赛名称
	StartTime         int64                    `protobuf:"varint,2,opt,name=startTime,proto3" json:"startTime,omitempty"`                 //      当前比赛开始时间戳
	List              []*FootMatchRealTimeInfo `protobuf:"bytes,3,rep,name=list,proto3" json:"list,omitempty"`                            //  数据列表
	TournamentImage   string                   `protobuf:"bytes,4,opt,name=tournamentImage,proto3" json:"tournamentImage,omitempty"`      //  当前联赛的图片
	Color             string                   `protobuf:"bytes,5,opt,name=color,proto3" json:"color,omitempty"`                          //  联赛颜色
	EventStatusResult int64                    `protobuf:"varint,6,opt,name=eventStatusResult,proto3" json:"eventStatusResult,omitempty"` //后端用来排序前端不用管
	TournamentId      int64                    `protobuf:"varint,7,opt,name=tournamentId,proto3" json:"tournamentId,omitempty"`           //后端用来排序
}

func (x *FootMatchRealTimeList) Reset() {
	*x = FootMatchRealTimeList{}
	if protoimpl.UnsafeEnabled {
...
func (x *FootMatchRealTimeList) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*FootMatchRealTimeList) ProtoMessage() {}

func (x *FootMatchRealTimeList) ProtoReflect() protoreflect.Message {
	mi := &file_foot_match_real_time_proto_msgTypes[2]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use FootMatchRealTimeList.ProtoReflect.Descriptor instead.
func (*FootMatchRealTimeList) Descriptor() ([]byte, []int) {
	return file_foot_match_real_time_proto_rawDescGZIP(), []int{2}
}

func (x *FootMatchRealTimeList) GetTournamentName() string {
	if x != nil {
...
func (x *FootMatchRealTimeList) GetStartTime() int64 {
	if x != nil {
		return x.StartTime
	}
	return 0
...
func (x *FootMatchRealTimeList) GetList() []*FootMatchRealTimeInfo {
	if x != nil {
		return x.List
	}
	return nil
...
func (x *FootMatchRealTimeList) GetTournamentImage() string {
	if x != nil {
...
func (x *FootMatchRealTimeList) GetColor() string {
	if x != nil {
		return x.Color
	}
	return ""
...
func (x *FootMatchRealTimeList) GetEventStatusResult() int64 {
	if x != nil {
...
func (x *FootMatchRealTimeList) GetTournamentId() int64 {
	if x != nil {
		return x.TournamentId
	}
	return 0
...
type FootMatchRealTimeInfo struct {
	...
	MainCustScore            string          `protobuf:"bytes,98,opt,name=mainCustScore,proto3" json:"mainCustScore,omitempty"`                       //主客总比分
	...
	ClassifyTime             string          `protobuf:"bytes,45,opt,name=classifyTime,proto3" json:"classifyTime,omitempty"`                         //分类用的时间
	IsVisible                int64           `protobuf:"varint,46,opt,name=is_visible,json=isVisible,proto3" json:"is_visible,omitempty"`             //是否可见：0隐藏 1可见
	Atm                      int64           `protobuf:"varint,47,opt,name=atm,proto3" json:"atm,omitempty"`                                          //data_match.start_time
	Del                      int64           `protobuf:"varint,48,opt,name=del,proto3" json:"del,omitempty"`                                          //比赛是否删除
	IsShow                   int64           `protobuf:"varint,49,opt,name=is_show,json=isShow,proto3" json:"is_show,omitempty"`                      //比赛是否显示
}
...
func (x *FootMatchRealTimeInfo) GetMainCustScore() string {
	if x != nil {
...
func (x *FootMatchRealTimeInfo) GetClassifyTime() string {
	if x != nil {
...
func (x *FootMatchRealTimeInfo) GetIsVisible() int64 {
	if x != nil {
		return x.IsVisible
	}
	return 0
...
func (x *FootMatchRealTimeInfo) GetAtm() int64 {
	if x != nil {
		return x.Atm
	}
	return 0
...
func (x *FootMatchRealTimeInfo) GetDel() int64 {
	if x != nil {
		return x.Del
	}
	return 0
...
func (x *FootMatchRealTimeInfo) GetIsShow() int64 {
	if x != nil {
		return x.IsShow
	}
	return 0
...
func (x *FootTeamInfo) GetRank() int64 {
	if x != nil {
		return x.Rank
	}
	return 0
...
func (x *FootOdds) Reset() {
	*x = FootOdds{}
	if protoimpl.UnsafeEnabled {
		mi := &file_foot_match_real_time_proto_msgTypes[7]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*FootOdds) Descriptor() ([]byte, []int) {
	return file_foot_match_real_time_proto_rawDescGZIP(), []int{7}
}
...
var file_foot_match_real_time_proto_rawDesc = []byte{
	...
	0x6c, 0x5f, 0x74, 0x69, 0x6d, 0x65, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x22, 0x91, 0x02, 0x0a,
	...
	0x6e, 0x61, 0x74, 0x69, 0x6f, 0x6e, 0x49, 0x64, 0x18, 0x09, 0x20, 0x03, 0x28, 0x03, 0x52, 0x08,
	0x6e, 0x61, 0x74, 0x69, 0x6f, 0x6e, 0x49, 0x64, 0x12, 0x1a, 0x0a, 0x08, 0x65, 0x76, 0x65, 0x6e,
	0x74, 0x49, 0x64, 0x73, 0x18, 0x02, 0x20, 0x03, 0x28, 0x03, 0x52, 0x08, 0x65, 0x76, 0x65, 0x6e,
	0x74, 0x49, 0x64, 0x73, 0x12, 0x1a, 0x0a, 0x08, 0x6c, 0x61, 0x6e, 0x67, 0x75, 0x61, 0x67, 0x65,
	0x18, 0x08, 0x20, 0x01, 0x28, 0x09, 0x52, 0x08, 0x6c, 0x61, 0x6e, 0x67, 0x75, 0x61, 0x67, 0x65,
	0x22, 0x5d, 0x0a, 0x19, 0x46, 0x6f, 0x6f, 0x74, 0x4d, 0x61, 0x74, 0x63, 0x68, 0x52, 0x65, 0x61,
	...
	0x0b, 0x32, 0x16, 0x2e, 0x46, 0x6f, 0x6f, 0x74, 0x4d, 0x61, 0x74, 0x63, 0x68, 0x52, 0x65, 0x61,
	0x6c, 0x54, 0x69, 0x6d, 0x65, 0x4c, 0x69, 0x73, 0x74, 0x52, 0x04, 0x6c, 0x69, 0x73, 0x74, 0x22,
	0x9b, 0x02, 0x0a, 0x15, 0x46, 0x6f, 0x6f, 0x74, 0x4d, 0x61, 0x74, 0x63, 0x68, 0x52, 0x65, 0x61,
	0x6c, 0x54, 0x69, 0x6d, 0x65, 0x4c, 0x69, 0x73, 0x74, 0x12, 0x26, 0x0a, 0x0e, 0x74, 0x6f, 0x75,
	0x72, 0x6e, 0x61, 0x6d, 0x65, 0x6e, 0x74, 0x4e, 0x61, 0x6d, 0x65, 0x18, 0x01, 0x20, 0x01, 0x28,
	...
	,
	...
	,
	...
	0x74, 0x65, 0x61, 0x6d, 0x43, 0x75, 0x73, 0x74, 0x22, 0x48, 0x0a, 0x0e, 0x46, 0x6f, 0x6f, 0x74,
	0x43, 0x6f, 0x72, 0x6e, 0x65, 0x72, 0x4b, 0x69, 0x63, 0x6b, 0x12, 0x1a, 0x0a, 0x08, 0x74, 0x65,
	0x61, 0x6d, 0x4d, 0x61, 0x69, 0x6e, 0x18, 0x02, 0x20, 0x01, 0x28, 0x03, 0x52, 0x08, 0x74, 0x65,
	0x61, 0x6d, 0x4d, 0x61, 0x69, 0x6e, 0x12, 0x1a, 0x0a, 0x08, 0x74, 0x65, 0x61, 0x6d, 0x43, 0x75,
	0x73, 0x74, 0x18, 0x01, 0x20, 0x01, 0x28, 0x03, 0x52, 0x08, 0x74, 0x65, 0x61, 0x6d, 0x43, 0x75,
	0x73, 0x74, 0x22, 0x84, 0x01, 0x0a, 0x0c, 0x66, 0x6f, 0x6f, 0x74, 0x54, 0x65, 0x61, 0x6d, 0x49,
	...
	,
...
var file_foot_match_real_time_proto_msgTypes = make([]protoimpl.MessageInfo, 8)
var file_foot_match_real_time_proto_goTypes = []interface{}{
	...
	(*FootMatchRealTimeList)(nil),     // 2: FootMatchRealTimeList
	(*FootMatchRealTimeInfo)(nil),     // 3: FootMatchRealTimeInfo
	(*FootHalfCourt)(nil),             // 4: FootHalfCourt
	(*FootCornerKick)(nil),            // 5: FootCornerKick
	(*FootTeamInfo)(nil),              // 6: footTeamInfo
	(*FootOdds)(nil),                  // 7: FootOdds
}
var file_foot_match_real_time_proto_depIdxs = []int32{
	2, // 0: FootMatchRealTimeResponse.list:type_name -> FootMatchRealTimeList
	3, // 1: FootMatchRealTimeList.list:type_name -> FootMatchRealTimeInfo
	4, // 2: FootMatchRealTimeInfo.halfCourt:type_name -> FootHalfCourt
	5, // 3: FootMatchRealTimeInfo.cornerKick:type_name -> FootCornerKick
	6, // 4: FootMatchRealTimeInfo.teamMain:type_name -> footTeamInfo
	6, // 5: FootMatchRealTimeInfo.teamCust:type_name -> footTeamInfo
	7, // 6: FootMatchRealTimeInfo.odds:type_name -> FootOdds
...
func file_foot_match_real_time_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_foot_match_real_time_proto_msgTypes[2].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*FootMatchRealTimeList); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_foot_match_real_time_proto_msgTypes[7].Exporter = func(v interface{}, i int) interface{} {
