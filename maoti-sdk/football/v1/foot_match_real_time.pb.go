...
type FootMatchRealTimeList struct {
	...
	ClassifyTime      string                   `protobuf:"bytes,7,opt,name=classifyTime,proto3" json:"classifyTime,omitempty"`            //分类用的时间
}
...
func (x *FootMatchRealTimeList) GetClassifyTime() string {
	if x != nil {
...
var file_foot_match_real_time_proto_rawDesc = []byte{
	...
	0x0c, 0x63, 0x6c, 0x61, 0x73, 0x73, 0x69, 0x66, 0x79, 0x54, 0x69, 0x6d, 0x65, 0x18, 0x07, 0x20,
	0x01, 0x28, 0x09, 0x52, 0x0c, 0x63, 0x6c, 0x61, 0x73, 0x73, 0x69, 0x66, 0x79, 0x54, 0x69, 0x6d,
	0x65, 0x22, 0xbf, 0x0d, 0x0a, 0x15, 0x46, 0x6f, 0x6f, 0x74, 0x4d, 0x61, 0x74, 0x63, 0x68, 0x52,
