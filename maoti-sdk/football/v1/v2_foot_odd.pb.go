...
type V2FootMatchEuropeanOddsListResponse struct {
	...
	List    []*V2OddDetailList `protobuf:"bytes,5,rep,name=list,proto3" json:"list,omitempty"`
}
...
var file_v2_foot_odd_proto_rawDesc = []byte{
	...
	0x76, 0x65, 0x72, 0x61, 0x67, 0x65, 0x12, 0x24, 0x0a, 0x04, 0x6c, 0x69, 0x73, 0x74, 0x18, 0x05,
