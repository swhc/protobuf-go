...
type FootMatchRealTimeInfoV2 struct {
	...
	Del       int64  `protobuf:"varint,34,opt,name=del,proto3" json:"del,omitempty"`                              //比赛是否删除
	IsShow    int64  `protobuf:"varint,37,opt,name=is_show,json=isShow,proto3" json:"is_show,omitempty"`          //比赛是否显示
}
...
func (x *FootMatchRealTimeInfoV2) GetDel() int64 {
	if x != nil {
		return x.Del
	}
	return 0
...
func (x *FootMatchRealTimeInfoV2) GetIsShow() int64 {
	if x != nil {
		return x.IsShow
	}
	return 0
...
var file_foot_match_real_time_v2_proto_rawDesc = []byte{
	...
	0x49, 0x6e, 0x66, 0x6f, 0x56, 0x32, 0x52, 0x04, 0x6c, 0x69, 0x73, 0x74, 0x22, 0xa9, 0x04, 0x0a,
	...
	0x74, 0x6d, 0x18, 0x21, 0x20, 0x01, 0x28, 0x03, 0x52, 0x03, 0x61, 0x74, 0x6d, 0x12, 0x10, 0x0a,
	0x03, 0x64, 0x65, 0x6c, 0x18, 0x22, 0x20, 0x01, 0x28, 0x03, 0x52, 0x03, 0x64, 0x65, 0x6c, 0x12,
	0x17, 0x0a, 0x07, 0x69, 0x73, 0x5f, 0x73, 0x68, 0x6f, 0x77, 0x18, 0x25, 0x20, 0x01, 0x28, 0x03,
	0x52, 0x06, 0x69, 0x73, 0x53, 0x68, 0x6f, 0x77, 0x42, 0x07, 0x5a, 0x05, 0x2e, 0x2f, 0x3b, 0x76,
