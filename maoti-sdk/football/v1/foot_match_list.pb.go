...
type FootMatchList struct {
	...
	Round         string `protobuf:"bytes,12,opt,name=round,proto3" json:"round,omitempty"`                                        //   供应商比赛轮次
	RoundType     string `protobuf:"bytes,13,opt,name=round_type,json=roundType,proto3" json:"round_type,omitempty"`               //   供应商比赛轮次类型
	MainHalfScore string `protobuf:"bytes,14,opt,name=main_half_score,json=mainHalfScore,proto3" json:"main_half_score,omitempty"` //主队半场比分
	CustHalfScore string `protobuf:"bytes,15,opt,name=cust_half_score,json=custHalfScore,proto3" json:"cust_half_score,omitempty"` //客队半场比分
	CptTime       int64  `protobuf:"varint,16,opt,name=cpt_time,json=cptTime,proto3" json:"cpt_time,omitempty"`                    //日期时间戳
}
...
func (x *FootMatchList) GetRound() string {
	if x != nil {
		return x.Round
	}
	return ""
...
func (x *FootMatchList) GetRoundType() string {
	if x != nil {
		return x.RoundType
	}
	return ""
...
func (x *FootMatchList) GetMainHalfScore() string {
	if x != nil {
...
func (x *FootMatchList) GetCustHalfScore() string {
	if x != nil {
...
func (x *FootMatchList) GetCptTime() int64 {
	if x != nil {
		return x.CptTime
	}
	return 0
...
var file_foot_match_list_proto_rawDesc = []byte{
	...
	0x68, 0x4c, 0x69, 0x73, 0x74, 0x52, 0x04, 0x6c, 0x69, 0x73, 0x74, 0x22, 0x8e, 0x04, 0x0a, 0x0d,
	...
	,
