...
var file_server_proto_rawDesc = []byte{
	...
	0x01, 0x28, 0x09, 0x52, 0x04, 0x64, 0x61, 0x74, 0x61, 0x32, 0x9c, 0x0b, 0x0a, 0x0a, 0x42, 0x61,
	...
	0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x22, 0x00, 0x12, 0x2e, 0x0a, 0x0b, 0x4d, 0x61, 0x74, 0x63,
	0x68, 0x46, 0x69, 0x6e, 0x69, 0x73, 0x68, 0x12, 0x13, 0x2e, 0x46, 0x69, 0x6e, 0x69, 0x73, 0x68,
	0x4d, 0x61, 0x74, 0x63, 0x68, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x1a, 0x08, 0x2e, 0x52,
	0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x22, 0x00, 0x42, 0x07, 0x5a, 0x05, 0x2e, 0x2f, 0x3b, 0x76,
...
var file_server_proto_depIdxs = []int32{
	...
	0,  // 53: BasketBall.MatchFinish:output_type -> Request
...
type BasketBallClient interface {
	...
	//获取已经完成的比赛
	MatchFinish(ctx context.Context, in *FinishMatchRequest, opts ...grpc.CallOption) (*Request, error)
}
...
func (c *basketBallClient) MatchFinish(ctx context.Context, in *FinishMatchRequest, opts ...grpc.CallOption) (*Request, error) {
	out := new(Request)
...
type BasketBallServer interface {
	...
	//获取已经完成的比赛
	MatchFinish(context.Context, *FinishMatchRequest) (*Request, error)
}
...
func (*UnimplementedBasketBallServer) MatchFinish(context.Context, *FinishMatchRequest) (*Request, error) {
