...
type PushSettingRequestParam struct {
	...
	Field   string `protobuf:"bytes,2,opt,name=Field,proto3" json:"Field,omitempty"`      // 要更新的字段
	IsLogin int64  `protobuf:"varint,3,opt,name=IsLogin,proto3" json:"IsLogin,omitempty"` //是否游客  0：否，1：是
	Value   string `protobuf:"bytes,4,opt,name=Value,proto3" json:"Value,omitempty"`      //要更新的值
}
...
func (x *PushSettingRequestParam) GetField() string {
	if x != nil {
		return x.Field
	}
	return ""
...
func (x *PushSettingRequestParam) GetValue() string {
	if x != nil {
		return x.Value
	}
	return ""
...
var file_collect_v2_proto_rawDesc = []byte{
	...
	,
...
var file_collect_v2_proto_msgTypes = make([]protoimpl.MessageInfo, 3)
